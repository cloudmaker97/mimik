    ...
    <div className="flex flex-col items-center justify-center flex-1 min-h-[300px]">
      <div className="relative">
        <svg width="72" height="54" viewBox="20 50 160 120" className="block">
          ...
          <line x1="66" y1="120" x2="86" y2="120" className="stroke-gold" strokeWidth="4" strokeLinecap="round" />
          <line x1="114" y1="120" x2="134" y2="120" className="stroke-gold" strokeWidth="4" strokeLinecap="round" />
          <path
